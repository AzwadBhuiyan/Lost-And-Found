    ...
    <div class="property-form-block">
        ...
        <p>You are not required to provide personally identifiable information to browse our web site. For the purposes of
             this privacy statement, we regard information as “personally identifiable” if the information, individually
              or in the aggregate, discloses the identity of a user, such as the user’s name, phone number, address or 
              e-mail address. If you choose to utilize our services by filling out a listing, however, you are required to
               provide your email address and phone number and, if any fees are incurred, you will be required to submit
                your credit/debit card information to pay for such fees.</p>
        <p>Except as set forth below, we do not share personal information with outside third parties.
             The nature of our services, however, require that third parties be able to contact individuals who list
              items on our web site. Therefore, once your listing is posted on our web site, your phone number will be
               available to third parties to contact you. Please refer to our User Agreement for further information on interacting with third parties regarding your listings. You always have the option to not provide personally identifiable information by choosing not to use our services.</p>
        <p>We may share personal information in order to investigate, prevent or take action regarding illegal activities,
        ...
        <p>Our web site keeps track of the pages visited by our users by placing a small entry in a text file, called a
             ...
             information from your browser, including your IP address and the pages you use to deliver content specific
              to your interests and to recognize your account number on return visits to our web site. The cookie
