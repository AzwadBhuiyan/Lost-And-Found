        ...
        <div class="container col-lg-4   order-1 order-sm-2   order-md-2  ">
         ...
         <!--   <nav class="navbar navbar-dark bg-danger  ">
            ...
            <div class="right_section" >
                   ...
                   <div class="card text-white bg-light m-3 cardDiv2  " style="width: 90%; margin: 15px; ">
                    <img src="./images/{{$item->id}}_1.jpg" class="card-img-top  rimg"  alt="...">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-7 col-sm-4">
                          <h5 class="card-title lh-base h5_2">{{$item->title}}</h5>
                          <h6 class="text-opacity-70 h6_2">Location:{{$item->location}}</h6>
